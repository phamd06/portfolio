...
- **A29** – Find a publicly available AI-generated image/video/audio and analyse it with a detector
...
- Each activity folder contains relevant supporting evidence such as screenshots, code, images, or written explanations.
- Activities were completed in accordance with the portfolio guidelines and are organised for easy navigation and review.
- This repository is used as supporting evidence for the final portfolio submission.
